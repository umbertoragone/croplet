...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className="relative z-0 h-1.5 w-full grow rounded-full bg-[#dceae7] data-[disabled]:bg-[#16302b12]">
        <SliderPrimitive.Range className="absolute h-full rounded-full bg-[#1b6b63] data-[disabled]:bg-[#6a8680]" />
